  ...
  return (
    <div className="dashboard-container">
      <div className="earnings-container">
        ...
        <div className="earning-card">
          <Card>
            <Statistic title="Customers" value={100} prefix={<UserOutlined />} />
          </Card>
        </div>
        <div className="earning-card">
          <Card>
      ...
      <Row gutter={16}>
        <Col span={24} className="graph">
          <Card title="This Week Sales & Purchases" className="graph-container">
            <Area {...salesConfig} />
          </Card>
          <Card title="Top Selling Products (2024)" className="graph-container">
            <Pie {...pieConfig} />
          </Card>
        </Col>
      </Row>
